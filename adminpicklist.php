			  			...
			  			<tr id="row<?php echo $x; ?>" class="<?php echo $arrayNumber; ?>">
							...
							<?php echo $orderItemData['country']; ?>
			  				...
			  				<td style="padding-left:20px;">							
			  					<input type="hidden" name="rate[]" id="rate<?php echo $x; ?>" autocomplete="off" disabled="true" class="form-control" value="<?php echo $orderItemData['rate']; ?>" />			  					
			  				...
			  				<td>
			  				<div class="form-group">
			  					<input type="text" name="adjustquantity[]" id="quantity<?php echo $x; ?>"  autocomplete="off" class="form-control" value="<?php echo $orderItemData['adjust_quan']; ?>" disabled/>
			  					</div>
			  				</td>
							...
							<input type="text" name="boxes[]" id="boxes<?php echo $x; ?>" autocomplete="off" class="form-control" value="<?php echo $orderItemData['boxes']; ?>" disabled/>
			  				...
			  				<td style="padding-left:20px;">
                                <!--<span class="glyphicon glyphicon-euro"></span>&nbsp;<span><?php echo $orderItemData['total']; ?></span>!-->							
			  					<input type="hidden" name="total[]" id="total<?php echo $x; ?>" autocomplete="off" class="form-control" disabled="true" value="<?php echo $orderItemData['total']; ?>"/>	  					
			  					<input type="hidden" name="totalValue[]" id="totalValue<?php echo $x; ?>" autocomplete="off" class="form-control" value="<?php echo $orderItemData['total']; ?>"/>			  					
			  				</td>

			  				<td>
			  				<div class="form-group">
			  					<input type="text" name="adjustboxes[]" id="quantity<?php echo $x; ?>"  autocomplete="off" class="form-control" value="<?php echo $orderItemData['adjust_box']; ?>"" disabled/>
			  					</div>
			  				</td>							
