  ...
  if(isset($_POST['update'])){
    ...
    if(empty($errors)){
		   ...
		   $address = remove_junk($db->escape($_POST['address']));
            ...
            $sql = "UPDATE users SET name ='{$name}', username ='{$username}',last_name='{$lastname}',company_name='{$company_name}',email='{$email}',phone='{$phone}',address='{$address}' WHERE id='{$id}'";
    $result = $db->query($sql);
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                 <div class="form-group">
                  ...
                  <input type="name" class="form-control" name="lastname" value="<?php echo remove_junk(ucwords($user['last_name'])); ?>">
            </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="company_name" value="<?php echo remove_junk(ucwords($user['company_name'])); ?>">
            </div>
              </div>
              <div class="col-md-6">
                 <div class="form-group">
              ...
              <div class="col-md-6">
                 <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="phone" value="<?php echo remove_junk(ucwords($user['phone'])); ?>">
            </div>
              </div>              
              <div class="col-md-12">
                 <div class="form-group">
                  <label for="username" class="control-label">Address</label>
                  <input type="text" class="form-control" name="address" value="<?php echo remove_junk(ucwords($user['address'])); ?>">
            </div>
              </div>
            </div>
