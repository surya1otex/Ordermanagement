            ...
            for($x = 1; $x < 4; $x++) { ?>
              ...
              <td>
                ...
                <td>
                  ...
                  <input type="number" name="quantity[]" id="quantity<?php echo $x; ?>"  onkeyup="getTotal(<?php echo $x ?>)" autocomplete="off" class="form-control" min="1" placeholder="Kg" step=".01" required/>
                  </div>
                </td>
