			...
			<img src="https://forestflavour.com/wp-content/uploads/2019/02/LOGO.svg" class="logo-header">
			  ...
			  <table class="table" id="productTable">
			  	...
			  	<tbody>
			  		...
			  		$orderItemSql = "SELECT order_item.order_item_id, order_item.order_id, order_item.product_id, order_item.quantity, order_item.country, order_item.boxes, order_item.rate, order_item.total FROM order_item WHERE order_item.order_id = {$orderId}";
			  		...
			  		while($orderItemData = $orderItemResult->fetch_array()) { 
                        ...
                        <td style="width:100px">
                         <div class="form-group">
                         <select class="form-control" name="skus[]" id="productName<?php echo $x; ?>" onchange="getProductData(<?php echo $x; ?>)" required>
                      ...
                      while($row = $productData->fetch_array()) { 
                        ...
                        echo "<option value='".$row['prod_SKU']."' id='changeProduct".$row['id']."' ".$selected.">".$row['prod_SKU']."</option>";
                      } // /while 
                ...
                <td>
                  <div class="form-group">
                  <select class="form-control js-example-basic-single" name="productName[]" id="productNames<?php echo $x; ?>" onchange="getProductDatatwo(<?php echo $x; ?>)" required>
			  						...
			  						<?php
			  							...
			  							while($row = $productData->fetch_array()) {	
                                            //print_r($row);								 		
			  								...
			  								echo "<option value='".$row['id']."' id='changeProduct".$row['id']."' ".$selected." >".$row['name'].'-'.$row['prod_SKU']."</option>";
											} 
										 	 //} // /while 
                  ...
                  <!--<p id="countrycode<?php echo $x; ?>"></p>!-->
				          <input type="text" name="country[]" class="form-control" id="country<?php echo $x; ?>" value="<?php echo $orderItemData['country']; ?>"/>
                              </div>
                              </td>

			  				<td style="padding-left:20px;">
			  					<div class="form-group">
			  					<input type="number" name="quantity[]" id="quantity<?php echo $x; ?>" onkeyup="getTotal(<?php echo $x ?>)" autocomplete="off" class="form-control" min="1" value="<?php echo $orderItemData['quantity']; ?>" step=".01" />
			  					</div>
			  				</td>
							
				            <td>
				<div class="form-group">
				<select name="taxes[]" id="boxName<?php echo $x; ?>" class="form-control">
  ...
  $.ajax({
    ...
    success:function(response) {
      ...
      var tr = '<tr id="row'+count+'" class="'+arrayNumber+'">'+
        ...
        '<td style="width:100px">'+
         '<div class="form-group">'+
		 '<select class="form-control" name="skus[]" id="productName'+count+'" onchange="getProductData('+count+')" >'+
		 '<option value="">ID</option>';
		...
		'<td>'+
		'<div class="form-group">'+
		'<input type="text" name="country[]" class="form-control" id="country'+count+'" autocomplete="off" />'+
		'</div>'+
		'</td>'+
        '<td style="padding-left:20px;">'+
          '<div class="form-group">'+
          '<input type="number" name="quantity[]" id="quantity'+count+'" onkeyup="getTotal('+count+')" autocomplete="off" class="form-control" placeholder="Kg" min="1" step=".01" />'+
          '</div>'+
        '</td>'+		
		'<td>'+
		'<div class="form-group">'+
